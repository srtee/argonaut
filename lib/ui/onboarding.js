...
export function updateOnboardingUI() {
    console.log('[Onboarding] updateOnboardingUI, currentStep:', currentStep, 'totalSteps:', totalSteps);
    if (!onboardingModal) {
        console.log('[Onboarding] updateOnboardingUI: no modal, returning early');
        return;
    }
...
export function nextStep() {
    console.log('[Onboarding] nextStep, currentStep:', currentStep, 'totalSteps:', totalSteps, 'modal:', !!onboardingModal, 'nextBtn:', !!onboardingNextBtn, 'backBtn:', !!onboardingBackBtn);
